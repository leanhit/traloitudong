<script lang="ts" src="@/scripts/image-manager/components/list.ts"></script>
                            ...
                            <table
                                ...
                                <tbody v-if="listItems && listItems.length > 0">
                                    <tr
                                        ...
                                        <td class="text-left text-truncate" :title="itemData.tags ? itemData.tags.join(', ') : ''">
                                          <span class="truncate-text">{{ itemData.tags ? itemData.tags.join(', ') : '' }}</span>
                                        </td>
                                        <td class="text-left text-truncate" :title="itemData.category">
